...
class MinecraftQuery
{
	...
	public function Connect($Ip, $Port = 25565, $Timeout = 3, $ResolveSRV = true)
	{
		...
		$this->Socket = @\stream_socket_client('tcp://' . $Ip . ':' . (int)$Port, $ErrNo, $ErrStr, (float)$Timeout, STREAM_CLIENT_ASYNC_CONNECT);
	...
	public function ConnectBedrock($Ip, $Port = 19132, $Timeout = 3, $ResolveSRV = true)
	{
		...
		$this->Socket = @\stream_socket_client('udp://' . $Ip . ':' . (int)$Port, $ErrNo, $ErrStr, (float)$Timeout, STREAM_CLIENT_ASYNC_CONNECT);
